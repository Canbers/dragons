...
const create = async (world, coordinates) => {
...
Format as JSON:
{
  ...
  "short": "<Two sentences capturing the essence>"
            ...
            return; // Successfully described the region, exit the loop
            ...
            if (e.code === 11000) { // Duplicate key error
                ...
                throw e; // Other error, exit the loop
            }
        }
    }
    throw new Error(`Failed to generate a unique region name for region with coordinates [${region.coordinates}] after ${attempt} attempts.`);
};
